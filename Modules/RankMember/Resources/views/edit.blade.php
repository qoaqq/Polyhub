...
<div class="card">
    ...
    <div class="card-body">
      <form class="needs-validation" action="{{route('rankmember.update',$rankmember->id)}}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="validationCustom01" name="rank"
              value="{{$rankmember->rank}}" required />
              @if ($errors->has('rank'))
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control" placeholder="Last name" name='min_points'
              value="{{$rankmember->min_points}}" required />

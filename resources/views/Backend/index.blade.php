              ...
              <ul class="hstack mb-0">
                <li class="ms-n2">
                  <a href="javascript:void(0)" class="">
                    <img src="{{ asset('storage/images/profile/user-2.jpg') }}"
                      class="rounded-circle border border-2 border-white" width="40" height="40" alt="">
                  </a>
                </li>
                <li class="ms-n2">
                  <a href="javascript:void(0)" class="">
                    <img src="{{ asset('storage/images/profile/user-3.jpg') }}"
                      class="rounded-circle border border-2 border-white" width="40" height="40" alt="">
                  </a>
                </li>
                <li class="ms-n2">
                  <a href="javascript:void(0)" class="">
                    <img src="{{ asset('storage/images/profile/user-4.jpg') }}"
                      class="rounded-circle border border-2 border-white" width="40" height="40" alt="">
                  </a>
                </li>
                <li class="ms-n2">
                  <a href="javascript:void(0)" class="">
                    <img src="{{ asset('storage/images/profile/user-5.jpg') }}"
                      class="rounded-circle border border-2 border-white" width="40" height="40" alt="">
                  </a>
                </li>
                <li class="ms-n2">
            ...
            <table class="table text-nowrap customize-table mb-0 align-middle">
              ...
              <tbody>
                <tr>
                  <td class="ps-0">
                    <div class="d-flex align-items-center product text-truncate">
                      <img src="{{ asset('storage/images/products/product-5.png') }}" class="img-fluid flex-shrink-0"
                        width="60" height="60">
                ...
                <tr>
                  <td class="ps-0">
                    <div class="d-flex align-items-center product text-truncate">
                      <img src="{{ asset('storage/images/products/product-6.png') }}" class="img-fluid flex-shrink-0"
                        width="60" height="60">
                      <div class="ms-3 product-title">
                ...
                <tr>
                  <td class="ps-0">
                    <div class="d-flex align-items-center product text-truncate">
                      <img src="{{ asset('storage/images/products/product-7.png') }}" class="img-fluid flex-shrink-0"
                        width="60" height="60">
                      <div class="ms-3 product-title">
                ...
                <tr>
                  <td class="ps-0">
                    <div class="d-flex align-items-center product text-truncate">
                      <img src="{{ asset('storage/images/products/product-8.png') }}" class="img-fluid flex-shrink-0"
                        width="60" height="60">
                      <div class="ms-3 product-title">
                ...
                <tr>
                  <td class="ps-0 border-bottom-0">
                    <div class="d-flex align-items-center product text-truncate">
                      <img src="{{ asset('storage/images/products/product-9.png') }}" class="img-fluid flex-shrink-0"
                        width="60" height="60">
                      <div class="ms-3 product-title">
            ...
            <table class="table mb-0 align-middle text-nowrap">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center text-truncate">
                      <img src="{{ asset('storage/images/profile/user-2.jpg') }}" alt=""
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center text-truncate">
                      <img src="{{ asset('storage//images/profile/user-3.jpg') }}" alt=""
                        class="img-fluid rounded-circle flex-shrink-0" width="32" height="32">
                      <div class="ms-7">
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center text-truncate">
                      <img src="{{ asset('storage/images/profile/user-4.jpg') }}" alt=""
                        class="img-fluid rounded-circle flex-shrink-0" width="32" height="32">
                      <div class="ms-7">
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center text-truncate">
                      <img src="{{ asset('storage/images/profile/user-5.jpg') }}" alt=""
                        class="img-fluid rounded-circle flex-shrink-0" width="32" height="32">
                      <div class="ms-7">
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center text-truncate">
                      <img src="{{ asset('storage/images/profile/user-6.jpg') }}" alt=""
                        class="img-fluid rounded-circle flex-shrink-0" width="32" height="32">
                      <div class="ms-7">
